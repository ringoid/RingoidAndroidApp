...
class DebugRepository @Inject constructor(
    ...
    override fun debugGetNewFaces(page: Int): Single<Feed> =
        Single.just(page).doOnSubscribe { Timber.v("Debug Feed: page: $page") }.compose {
            val feed = when (page) {
                ...
                3 -> Feed(profiles = listOf(
                    Profile(id = "5135f8abaa35400140c5e8ed14b2e65fd1e451e8", images = listOf(Image(id = "1440x1920_b9609534ffb499f8bad7cf553b120dc502d189d3", uri = "https://s3-eu-west-1.amazonaws.com/stage-ringoid-public-photo/b9609534ffb499f8bad7cf553b120dc502d189d3_1440x1920.jpg")))))
                else -> EmptyFeed
            }
            Single.just(feed)
        }
