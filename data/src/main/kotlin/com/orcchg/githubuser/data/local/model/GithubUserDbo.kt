package com.orcchg.githubuser.data.local.model

import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.PrimaryKey
import com.orcchg.githubuser.data.local.model.GithubUserDbo.Companion.TABLE_NAME
import com.orcchg.githubuser.domain.model.GithubUser
import com.orcchg.githubuser.domain.model.Mappable
...
data class GithubUserDbo(
    ...
    @ColumnInfo(name = COLUMN_AVATAR_URL) val avatarUrl: String? = null) : Mappable<GithubUser> {
    ...
    override fun map(): GithubUser = GithubUser(id = id, login = login, name = name, bio = bio, avatarUrl = avatarUrl)
}
