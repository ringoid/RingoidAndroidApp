...
/**
 * @see https://stackoverflow.com/questions/13095494/how-to-detect-swipe-direction-between-left-right-and-up-down
 */
open class SwipeGestureRecognizer : GestureDetector.SimpleOnGestureListener() {
    ...
    protected open fun onSwipe(direction: Direction): Boolean = false
