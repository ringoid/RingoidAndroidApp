...
import com.ringoid.domain.interactor.feed.property.ClearCachedUserMessagedFeedItemIdsUseCase
...
class LoginViewModel @Inject constructor(
    ...
    private val clearCachedUserMessagedFeedItemIdsUseCase: ClearCachedUserMessagedFeedItemIdsUseCase,
    ...
    fun onLogout() {
        clearLocalUserDataUseCase.source()
            ...
            .andThen(clearCachedUserMessagedFeedItemIdsUseCase.source())
