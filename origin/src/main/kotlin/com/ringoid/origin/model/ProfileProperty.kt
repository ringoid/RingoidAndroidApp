...
enum class EducationProfileProperty(val id: Int, @StringRes val resId: Int) {
    Unknown(0, R.string.profile_property_education),
    ...
    companion object {
        private val values: Array<EducationProfileProperty> = values()
...
enum class HairColorProfileProperty(val id: Int, @StringRes private val maleResId: Int, @StringRes private val femaleResId: Int) {
    Unknown(0, R.string.profile_property_hair_color, R.string.profile_property_hair_color),
    ...
    companion object {
        private val values: Array<HairColorProfileProperty> = values()
...
enum class IncomeProfileProperty(val id: Int, @StringRes val resId: Int) {
    Unknown(0, R.string.profile_property_income),
    ...
    companion object {
        private val values: Array<IncomeProfileProperty> = values()
...
enum class PropertyProfileProperty(val id: Int, @StringRes val resId: Int) {
    Unknown(0, R.string.profile_property_property),
    ...
    companion object {
        private val values: Array<PropertyProfileProperty> = values()
...
enum class TransportProfileProperty(val id: Int, @StringRes val resId: Int) {
    Unknown(0, R.string.profile_property_transport),
    ...
    companion object {
        private val values: Array<TransportProfileProperty> = values()
