...
fun navigate(activity: Activity, path: String, rc: Int = 0) {
...
fun navigateAndClose(activity: Activity, path: String, rc: Int = 0) {
    navigate(activity = activity, path = path, rc = rc)
    activity.finish()
}
