...
data class Lmm(val likes: List<FeedItem>, val matches: List<FeedItem>, val messages: List<FeedItem>, var hasNewMessages: Boolean = false) {
    ...
    fun messagesCount(): Int = messages.map { it.messages.size }.reduce { acc, i -> acc + i }
