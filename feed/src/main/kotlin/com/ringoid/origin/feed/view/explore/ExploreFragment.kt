...
class ExploreFragment : FeedFragment<ExploreViewModel, Profile, OriginFeedViewHolder<Profile>>() {
    ...
    override fun getEmptyStateInput(mode: Int): EmptyFragment.Companion.Input? =
        when (mode) {
            ...
            ViewState.CLEAR.MODE_NEED_REFRESH -> EmptyFragment.Companion.Input(emptyTitleResId = OriginR_string.feed_explore_empty_title, emptyTextResId = OriginR_string.feed_explore_empty_need_refresh)
            else -> null
        }
