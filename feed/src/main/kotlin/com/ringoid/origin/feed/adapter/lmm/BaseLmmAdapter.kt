...
abstract class BaseLmmAdapter(headerRows: Int = 1) : BaseFeedAdapter<
        FeedItemVO, OriginFeedViewHolder<FeedItemVO>>(FeedItemVODiffCallback(), headerRows = headerRows) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OriginFeedViewHolder<FeedItemVO> {
    ...
    // ------------------------------------------
    protected fun wrapMessageClickListener(vh: OriginFeedViewHolder<FeedItemVO>): ((model: FeedItemVO, position: Int) -> Unit)? =
