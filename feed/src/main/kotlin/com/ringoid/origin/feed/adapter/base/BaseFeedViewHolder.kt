...
abstract class BaseFeedViewHolder(view: View, viewPool: RecyclerView.RecycledViewPool? = null)
            ...
            addOnScrollListener(object : RecyclerView.OnScrollListener() {
                override fun onScrolled(rv: RecyclerView, dx: Int, dy: Int) {
                    ...
                    rv.linearLayoutManager()?.let {
                        ...
                        trackingBus?.postViewEvent(EqualRange(from = from, to = to, orientation = EqualRange.Orientation.HORIZONTAL, items = items))
    ...
    override fun bind(model: FeedItemVO) {
        ...
        if (BuildConfig.IS_STAGING) {
            itemView.tv_profile_id.text = model.hashIdWithFirst4()
        }
    }
